...
function Home() {
  ...
  return (
    ...
    <div>
      ...
      {/* Передаём форме список автомобилей и функцию для его изменения */}
      <CreateCarForm cars={cars} setCars={setCars} />

      {/* Блок с карточками машин */}
      <div>

        {/* Перебираем все машины из импортированного файла в обратном порядке и для каждой из них создаём собственную карточку */}
